...
int main(void)
{
  ...
  cout << "- liste->remove_next(liste->tail(),(void**)&data2)" << endl;
  liste->remove_next(liste->tail(),(void**)&data2);
  liste->display();
  cout << endl;

  cout << "- liste->remove_next(liste->tail(),(void**)&data3)" << endl;
  liste->remove_next(liste->tail(),(void**)&data3);
  liste->display();
  cout << endl;
